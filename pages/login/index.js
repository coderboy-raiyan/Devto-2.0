  ...
  return (
    <>
      ...
      <section className="bg-gray-100  flex justify-center  min-h-screen pt-10 px-4">
        <div className="bg-white rounded-lg border lg:w-2/4 md:w-2/4 w-full px-16 py-10 h-full min-h-[300px] shadow-sm">
          ...
          <p className="text-center text-sm">
            Dont have account?{" "}
            <Link href="/register">
              <a className="text-blue-700 hover:underline">Register</a>
            </Link>
          </p>
        </div>
      </section>
